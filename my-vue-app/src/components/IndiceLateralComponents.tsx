...
export default function IndiceLateral() {
  ...
  const sectionData = {
    section1: "La finalidad del sitio Web de Superadmin tiene por objeto informar sobre Superadmin, las actividades que realiza y de los Servicios que presta, atender las solicitudes de compra y facilitar a los clientes la gestión de los Servicios contratados.Además, el sitio web permite a los usuarios acceder a información actualizada sobre novedades, promociones y recursos relacionados con los servicios de Superadmin. A través de su plataforma, Superadmin busca ofrecer una experiencia intuitiva y segura, garantizando la privacidad de los datos de los clientes y promoviendo una comunicación fluida para atender consultas, resolver incidencias y gestionar sol.",
